...
#[derive(Debug)]
pub struct VM {
    registers: [i32; 32], // array simulates having registers
    pc: usize,            // program counter tracks current byte
    program: Vec<u8>,     // bytecode of program being run
    remainder: u32,       // remainder of modulo in division operation
    equal_flag: bool,     // contains result of last comparison
}
impl VM {
    pub fn new() -> VM {
        VM {
